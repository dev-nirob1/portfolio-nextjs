...
const projects = [
  ...
  { id: 3, title: "Merchant SaaS Platform", category: "full-stack", status: "published" },
];
              ...
              <tr key={project.id}>
                ...
                <td className="px-4 py-3.5">
                  <div className="flex items-center justify-end gap-2">
                    <button className="p-2 rounded-sm border border-line text-slate hover:border-ink hover:text-ink transition-colors cursor-pointer">
                      <FiEdit2 size={14} />
                    </button>
